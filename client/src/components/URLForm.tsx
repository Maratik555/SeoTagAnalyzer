    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8 card-hover animate-fadeIn">
      ...
      <form className="flex flex-col sm:flex-row gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex items-end">
          <button
            type="submit"
            className="btn px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-md hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 shadow-md"
            disabled={isLoading}
          >
            {isLoading ? (
